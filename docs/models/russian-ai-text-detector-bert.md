...
командой `aiw-ru models install transformer`, после чего `aiw-ru classify --model transformer текст.md`
...
| --- | --: | --: | --: | --: | --: |
| Accuracy | $0.945$ | $0.963$ | $0.948$ | $0.868$ | $0.503$ |
| ROC AUC | $0.987$ | $0.993$ | $0.991$ | $0.943$ | $0.615$ |
| ROC AUC, люди против текстов с нуля | $0.989$ | $0.994$ | $0.992$ | $0.946$ | $0.597$ |
| F1, среднее по классам | $0.943$ | $0.962$ | $0.945$ | $0.863$ | $0.466$ |
| Людей принято за ИИ | $7.2\%$ | $3.4\%$ | $9.5\%$ | $16.5\%$ | $5.9\%$ |
