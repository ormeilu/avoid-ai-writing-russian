...
- «Будущее за этой технологией», «время покажет», «одно можно сказать точно», «перспективы выглядят многообещающими», «впереди ещё много интересного». Удалить. Если нужен вывод, он должен следовать из аргумента.
