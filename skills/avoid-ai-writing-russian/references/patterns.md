...
- Не находки: BOM (U+FEFF) в самом начале файла, его пишут редакторы Windows; соединитель U+200D внутри составного эмодзи (👨 и 💻 в одном знаке); латинское сокращение через дефис с русским словом («HTTP-запрос», «OK-кнопка»). Подменой считается смесь алфавитов внутри одной части слова, а не в разных частях через дефис.
